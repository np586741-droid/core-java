class EatClub 
{
    ...
    {
        System.out.println("invoking getPriceByFoodName in EatClub: " + foodName);
        double price = 0.0;
    ...
    {
        System.out.println("invoking getTotalAmountByPriceAndQuantity in EatClub");
    ...
    {
        System.out.println("invoking getDiscount in EatClub");
        // Applying the 10% discount logic provided
